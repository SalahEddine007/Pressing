                    ...
                    <div class="hero-inner">
                        <div class="content content-full">
                            <div class="py-30 text-center">
                                ...
                                <h1 class="h2 font-w700 mt-30 mb-10">Oops.. We Found an Error Page..</h1>
                                <h2 class="h3 font-w400 text-muted mb-50">We are sorry but the page you are looking for was not found..</h2>
                                <a class="btn btn-hero btn-rounded btn-alt-secondary" href="index">
                                    <i class="fa fa-arrow-left mr-10"></i>Retour A L'Accueil
                                </a>
                            </div>
                        </div>
                    </div>
